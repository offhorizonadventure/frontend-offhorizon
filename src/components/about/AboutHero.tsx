...
export async function AboutHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-brand-950 pt-32 pb-20 text-cream-100 sm:pt-40 sm:pb-28">
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-8">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-16">
          ...
          <div
            className="hero-rise lg:col-span-5 lg:pt-24"
        ...
        <dl
          className="hero-rise mt-14 grid grid-cols-3 gap-6 border-t border-cream-100/12 pt-8 sm:mt-20"
        ...
        >
          {facts.map((fact) => (
            <div key={fact.key}>
              ...
              <dd className="mt-2.5 text-[10.5px] font-semibold tracking-[0.16em] text-cream-100/45 uppercase">
                {t(`facts.${fact.key}`)}
              </dd>
            </div>
          ))}
