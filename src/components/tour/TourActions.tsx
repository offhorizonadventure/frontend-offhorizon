  ...
  return (
    ...
    >
      ...
      >
        <span
          aria-hidden
          className="bg-ember-500 shadow-ember-500/20 hidden size-2 rounded-full shadow-[0_0_0_4px] sm:block"
        />
        {labels.trigger}
      </QuickEnquiryModal>
      ...
      <DatesDrawer
        ...
        booking={booking}
        className="bg-brand-800 text-cream-100 shadow-brand-950/25 hover:bg-brand-900 pointer-events-auto flex h-12 flex-1 basis-0 cursor-pointer items-center justify-center rounded-full px-5 text-[11px] font-bold tracking-[0.12em] whitespace-nowrap uppercase shadow-lg transition-colors duration-300 sm:hidden"
      />
    </div>
  );
}
