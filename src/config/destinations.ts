...
/**
 * Images are imported rather than referenced by path so the bundler
 * content-hashes them - swapping a photo busts the cache automatically, and
 * Next derives the dimensions and blur placeholder for us.
 *
